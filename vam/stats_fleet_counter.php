...
<?php
	...
	$sql = "select f.registry,TRUNCATE(sum(hours),2) hrs from regular_flights_tracks ft inner join fleets f on ft.fleet_id = f.fleet_id group by f.registry order by hrs desc limit 5";
