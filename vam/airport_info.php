	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo AIRPORT_AIRPORT_MAP; ?></h3>
			</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><?php echo AIRPORT_RUNWAY_INFO; ?></div>
			<table class="table table-hover">
				<?php
...
?>
	<div class="row">
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading"><?php echo AIRPORT_AIRPORT_FREQUENCIES; ?></div>
				<table class="table table-hover">
					<?php
						if (!$result = $db->query($sql)) {
							die('There was an error running the query  [' . $db->error . ']');
...
?>
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading"><?php echo AIRPORT_AIRPORT_NAVAIDS; ?></div>
			<table class="table table-hover">
				<?php
					if (!$result = $db->query($sql)) {
						die('There was an error running the query  [' . $db->error . ']');
