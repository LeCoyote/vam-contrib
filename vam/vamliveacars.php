...
for ($x=0; $x < $dataLenght ;$x++)
{
	...
	$sql = "insert into vam_live_acars (gvauser_id,flight_id,departure,arrival,ias,heading,gs,altitude,fuel,fuel_used,latitude,longitude,time_passed,perc_completed,oat,wind_deg,wind_knots,flight_status,plane_type,pending_nm) 
	values ('$gvauser_id ','$flightId ','$departure' ,'$arrival' ,'$ias','$heading','$gs','$altitude','$fuel','$fuel_used'
	,'$latitude','$longitude','$time_passed','$perc_completed','$oat','$wind_deg','$wind_knots','$flight_status','$plane_type','$pending_nm')";
	...
	$sql = "insert into vam_live_flights (gvauser_id,flight_id,departure,arrival,ias,heading,gs,altitude,fuel,fuel_used,latitude,longitude,time_passed,perc_completed,oat,wind_deg,wind_knots,flight_status,plane_type,pending_nm) 
	values ('$gvauser_id ','$flightId ','$departure' ,'$arrival' ,'$ias','$heading','$gs','$altitude','$fuel','$fuel_used'
	,'$latitude','$longitude','$time_passed','$perc_completed','$oat','$wind_deg','$wind_knots','$flight_status','$plane_type','$pending_nm')";
	echo $sql;
	if (!$result = $db->query($sql)) {
