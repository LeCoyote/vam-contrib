...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo PILOT_PROFILE; ?></h3>
			</div>
			<div class="panel-body">
				<table class="table table-hover">
					...
					<tr>
						...
						{
							echo '<font size="2">&nbsp;'.$hub_airport_name.'</font>';
						} ?>
						</td>
					</tr>
					<tr>
			...
			<div class="panel-body">
				<table class="table table-hover">
					...
					<tr>
						...
						<td><?php echo $transfered_hours + $gva_hours; ?></td>
					</tr>
					<tr>
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo PILOT_CERTIFICATIONS; ?></h3>
			</div>
			<div class="panel-body">
				<table class="table table-hover">
					<?php
