...
<div class="container">
	...
	<div id="navbar" class="navbar-collapse collapse">
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo ABOUT; ?><span
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a href="../vamcore/Gvausers"><span class="glyphicon glyphicon-briefcase"></span> <?php echo ADMIN; ?>
			...
			<li><a href="./logout.php"><span
						...
						class="glyphicon glyphicon-log-out"></span> <?php echo 'Log out ' . $_SESSION["user"]; ?></a>
