...
<div class="col-md-6">
	<div class="panel panel-default">
		...
		<div class="panel-heading"><?php echo HUB_PILOTS; ?></div>
	...
	<div class="col-md-6">
		<div class="panel panel-default" >
			<!-- Default panel contents -->
			<div class="panel-heading"><?php echo HUB_FLEET; ?></div>
			<div class="table-responsive" style="height:500px;overflow:auto">
			<!-- Table -->
			<table class="table table-hover">
				<?php
...
<div class="row">
	<div class="col-md-3">
		<div class="panel panel-default">
			<!-- Default panel contents -->
			<div class="panel-heading"><?php echo HUB_DETAILS ; ?></div>
			<div class="table-responsive" style="height:500px;overflow:auto">
				<!-- Table -->
				<table class="table table-hover">
					<?php
	...
	<div class="col-md-3">
		<div class="panel panel-default" >
			<!-- Default panel contents -->
			<div class="panel-heading"><?php echo HUB_ROUTES;  ?></div>
			<div class="table-responsive" style="height:500px;overflow:auto">
				<!-- Table -->
				<table class="table table-hover">
					<?php
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<!-- Default panel contents -->
			<div class="panel-heading"><?php echo HUB_MAP_LOCATION; ?></div>
